...
const PAGE_META = {
  '/': {
    ...
    canonical: 'https://www.tevrixai.com/',
  ...
  '/about': {
    ...
    canonical: 'https://www.tevrixai.com/about',
  ...
  '/ai-bpo': {
    ...
    canonical: 'https://www.tevrixai.com/ai-bpo',
  ...
  '/service/customer-care': {
    ...
    canonical: 'https://www.tevrixai.com/service/customer-care',
  ...
  '/service/hr-automation': {
    ...
    canonical: 'https://www.tevrixai.com/service/hr-automation',
  ...
  '/service/financial-analyst': {
    ...
    canonical: 'https://www.tevrixai.com/service/financial-analyst',
  ...
  '/service/document-intelligence': {
    ...
    canonical: 'https://www.tevrixai.com/service/document-intelligence',
  ...
  '/service/voice-ai': {
    ...
    canonical: 'https://www.tevrixai.com/service/voice-ai',
  ...
  '/service/custom-process': {
    ...
    canonical: 'https://www.tevrixai.com/service/custom-process',
  ...
  '/privacy': {
    ...
    canonical: 'https://www.tevrixai.com/privacy',
  ...
  '/terms': {
    ...
    canonical: 'https://www.tevrixai.com/terms',
